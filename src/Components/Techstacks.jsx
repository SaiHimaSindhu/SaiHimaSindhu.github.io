...
{/* <div className='skills-card'> */}
        ...
        <Tooltip hasArrow label="SQL"  className="tooltip-font " bg={"#35668F"} color={"white"}>
         
          <div className="coin Mongo_logo">
            <div className="side heads">

              <img className='css-logo-width skills-card-img logo_spin'  src={sql} alt="" />
            </div>
            <div className="side tails">
              <img className='css-logo-width logo_spin'  src={sql} alt="" />
